...
/**
 * Created by FancaoFaker on 8/3/2016.
 */
public class NguoiDungAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        //đổi màu
        if(position % 2 != 0){
            holder.txtName.setTextColor(ContextCompat.getColor(context,R.color.Xanh));
            holder.txtPhone.setTextColor(ContextCompat.getColor(context,R.color.Xanh));
        }else{
            holder.txtName.setTextColor(ContextCompat.getColor(context,R.color.Do));
            holder.txtPhone.setTextColor(ContextCompat.getColor(context,R.color.Do));
        }
        return convertView;
